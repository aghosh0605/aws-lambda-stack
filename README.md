...
ℹ️ Important Links to help you in future

- https://www.cloudmailin.com/blog/building-an-http-api-with-aws-lambda-and-sam
- https://www.mongodb.com/blog/post/optimizing-aws-lambda-performance-with-mongodb-atlas-and-nodejs
- https://github.com/supabase/supabase/issues/147
- https://middy.js.org/docs/writing-middlewares/configurable-middlewares
- https://stackoverflow.com/questions/31728414/mongodb-connections-from-aws-lambda
...
ℹ️ The interesting parts of the application, described in the blog are:

- [src/auth.js](./src/handlers/hello-from-lambda.js) The Node.js
  code for our actual Lambda function
- [events/name.json](./events/name.json) The sample event we'll pass into the
  Lambda function before we connect it to the Web with API Gateway. Postman can also be used instead of that.
...
- AWS CLI - [Install the AWS CLI](https://docs.aws.amazon.com/serverless-application-model/latest/developerguide/serverless-sam-cli-install.html).
- AWS SAM CLI - [Install the AWS SAM CLI](https://docs.aws.amazon.com/serverless-application-model/latest/developerguide/serverless-sam-cli-install.html).
- Node.js - [Install Node.js 14](https://nodejs.org/en/), including the npm package management tool.
- Docker - [Install Docker community edition](https://hub.docker.com/search/?type=edition&offering=community).

To build and deploy your application for the first time, run the following in your shell. Check `package.json` file to get more information:
...
## 🛠️ Use the AWS SAM CLI to build and test locally
...
```bash
my-application$ sam local invoke healthcheckFunction --no-event
```

# ☁️ Template.yml -> Add Resources

$${\color{red}template.yml \space for \space Cloudformation}$$
...
$${\color{green}Better \space Version \space with \space Roles}$$
...
Resources:
  ...
  healthcheckFunction:
    ...
    Properties:
      ...
      #Role with LambdaBasicExecutionRole Policy
      Role: arn:aws:iam::XXXXXXXXXXXXX:role/lambda-role-XXXXXXXXXX
      Events:
        HealthCheckAPI:
          Type: Api
          Properties:
...
```bash
my-application$ sam logs -n healthcheckFunction --stack-name sam-app --tail
```
